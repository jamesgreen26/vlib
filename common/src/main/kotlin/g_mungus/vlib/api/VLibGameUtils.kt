...
object VLibGameUtils {
    ...
    @Deprecated("Moved to VLibAPI class")
    ...
    fun assembleByConnectivity(level: ServerLevel, blockPos: BlockPos, blackList: List<Block>): CompletionStage<Ship> {
        ...
        VLibAPI.assembleByConnectivity(level, blockPos, blackList)?.let {
            return CompletableFuture.completedFuture(it)
        }
        return CompletableFuture.failedFuture(Exception("Assembly failed"))
    }
